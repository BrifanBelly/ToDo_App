var myApp = angular.module('myApp', [
    ...
    config(['$routeProvider', '$locationProvider', function($routeProvider, $locationProvider){
        ...
        $routeProvider.when('/signup', {templateUrl: '/partials/auth/signup.html', controller: 'authController'});
        $routeProvider.when('/signin', {templateUrl: '/partials/auth/signin.html', controller: 'authController'});
